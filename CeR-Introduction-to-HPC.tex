...
\frame[t]
{
  \frametitle{Key Concepts}
   ...
   \begin{itemize}%[<+-| alert@+>]
	...
	\item Many scientific software applications are written to take advantage of multiple cores in some way. But often this must be specifically requested by the user at the time he runs the program, rather than happening automagically.
...
\frame[t]
{
   ...
   \begin{itemize}%[<+-| alert@+>]
	...
	\item Unbalanced load: one slow core will hold up all the others.
	\end{itemize}
...
{
  \frametitle{Using the Cluster}
  \begin{block}{Each NeSI Supercomputing Centre has one or more Login Nodes}
   \begin{itemize}%[<+-| alert@+>]
	\item \textbf{CeR}
	   \begin{itemize}%[<+-| alert@+>]
	    \item {\url{login.uoa.nesi.org.nz}}, the Red Hat login node.
	    %\item visual.uoa.nesi.org.nz  which is the Visualization Cluster login node.
       \end{itemize}
	\item \textbf{BlueFern}
	   \begin{itemize}%[<+-| alert@+>]
	    \item {\url{kerr.canterbury.ac.nz}}, the AIX login node.
	    \item {\url{beatrice.canterbury.ac.nz}}, the SUSE Linux login node.
	    \item {\url{foster.canterbury.ac.nz}}, the BlueGene/P login node
	    \item {\url{popper.canterbury.ac.nz}}, the Visualization Cluster login node.
   \end{itemize}
   	\item \textbf{NIWA}
	   \begin{itemize}%[<+-| alert@+>]
	    \item {\url{fitzroy.nesi.org.nz}}, the AIX login node.
      \end{itemize}
   \end{itemize}
  \end{block}
}
...
\frame[t]
{
  \frametitle{Submitting a Job}
   ...
   \begin{itemize}%[<+-| alert@+>]
	\item Centre-specific documentation:
	\begin{itemize}
	...
	\item Take a look at the Quick Reference Guide: \url{http://goo.gl/ytbRWy}
...
\frame[t]
{
  \frametitle{Submitting a Job}
   ...
   \begin{itemize}%[<+-| alert@+>]
	...
	\item \textbf{CPU cores}: How many to use? Some programs try to use more cores than they are allocated, e.g.\ MATLAB.
