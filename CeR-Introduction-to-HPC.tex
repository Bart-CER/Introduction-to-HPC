...
\frame{
\frametitle{GPU and Phi computing}
...
\frame[t]
{
  \frametitle{Our Facilities}
      ...
      \end{center}
  \end{block}
  More information on the documentation page under \textsl{Available hardware.}
}
...
\begin{itemize}
 ...
 \item What is the error that is printed to the screen? (Did you read it yourself?)
